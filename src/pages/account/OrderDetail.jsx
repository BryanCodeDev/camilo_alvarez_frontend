...
const statusConfig = {
  ...
  cancelled: { label: 'Cancelado', bg: 'bg-red-600/20', text: 'text-red-400', border: 'border-red-600/30' },
  refunded: { label: 'Reembolsado', bg: 'bg-gray-600/20', text: 'text-white', border: 'border-gray-600/30' },
}
    ...
    return (
      <div className="min-h-screen bg-primary-900 pt-20 flex items-center justify-center">
        <div className="container-custom text-center py-20">
          <h1 className="font-display font-bold text-3xl text-white mb-2">Pedido no encontrado</h1>
          <p className="text-white mb-6">No se pudo encontrar este pedido.</p>
        ...
        <div className="container-custom py-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="font-display font-bold text-3xl sm:text-4xl text-white">Pedido #{order.order_number}</h1>
                <p className="text-white mt-2">Realizado el {formatDateTime(order.created_at)}</p>
              </div>
