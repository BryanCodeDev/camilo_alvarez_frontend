      ...
      <>
        ...
        <div className="min-h-screen bg-primary-900 pt-20 flex items-center justify-center">
          <div className="container-custom text-center py-20">
            <svg className="w-20 h-20 text-primary-600 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
            <h1 className="font-display font-bold text-3xl text-white mb-2">Producto no encontrado</h1>
            <p className="text-white mb-6">El producto que buscas no existe o ha sido eliminado.</p>
      ...
      <div className="min-h-screen bg-primary-900 pt-20">
        <div className="container-custom py-8">
          ...
          >
            <div className="space-y-4">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden bg-primary-800 border border-dark-border">
                ...
                {zoomActive && (
                  <div className="absolute inset-0 bg-black/50 z-10 flex items-center justify-center">
                    ...
                    <button
                      ...
                      className="absolute top-4 right-4 p-2 bg-primary-900/80 rounded-full text-white hover:bg-primary-800"
                ...
                <button
                  ...
                  className="absolute top-4 right-4 p-2 bg-primary-900/80 rounded-full text-white hover:bg-primary-800 transition-colors z-10"
            ...
            <div className="space-y-6">
              <div>
                <span className="inline-block px-3 py-1 bg-primary-800 border border-dark-border rounded-full text-xs font-medium text-white mb-3">
                  {product.category}
                </span>
                <motion.h1
                  initial={{ opacity: 0, y: 10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="font-display font-bold text-3xl sm:text-4xl text-white mb-3"
                >
                  {product.name}
                </motion.h1>
                ...
                {product.rating && (
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-white">({product.reviewCount || 0} reseñas)</span>
                    <span className="text-white">·</span>
                    <span className="text-white">SKU: {product.sku}</span>
                  </div>
                )}
                ...
                <div className="flex items-baseline gap-4 flex-wrap mb-4">
                  ...
                  {product.originalPrice && product.price < product.originalPrice && (
                    <span className="text-white line-through text-lg">{formatPrice(product.originalPrice)}</span>
                  )}
                  {discount > 0 && (
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="flex items-center border border-dark-border rounded-lg overflow-hidden">
                      ...
                      <input
                        ...
                        min="1"
                        max={product.stock}
                        className="w-16 text-center bg-transparent border-0 focus:outline-none text-white font-medium"
                        aria-label="Cantidad"
                      />
                      <button
                    ...
                    <span className="text-white text-sm">Disponibles: {product.stock}</span>
                  </div>
                </div>
            ...
            >
              <div className="border border-dark-border rounded-2xl overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  {product.warranty && (
                    <div className="mt-12">
                      <h3 className="font-display font-semibold text-xl text-white mb-6">Garantía y soporte</h3>
                      <div className="prose prose-invert max-w-none text-white">
