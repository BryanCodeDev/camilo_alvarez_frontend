      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md z-50 bg-primary-800 border-l border-dark-border flex flex-col shadow-card"
            role="dialog"
                ...
                <div className="space-y-4">
                  {items.map((item, index) => (
                    <motion.div
                      ...
                      exit={{ opacity: 0, x: -20 }}
                      className="flex gap-3 p-3 bg-primary-700/50 rounded-xl border border-dark-border"
                    >
                      <Link to={`/producto/${item.slug}`} className="relative w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden bg-primary-700">
                        <img
                          src={item.image}
                          alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          ...
                          <span className="flex-1 text-right text-white text-sm font-medium">
            ...
            {items.length > 0 && (
              <div className="p-4 border-t border-dark-border space-y-4">
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-white border-t border-dark-border pt-2">
                    <span>Envío</span>
                ...
                <p className="text-center text-white text-xs">
                  También puedes comprar por <a href={getWhatsAppUrlForCart(items, total)} target="_blank" rel="noopener noreferrer" className="text-green-500 hover:underline">WhatsApp</a>
                </p>
              </div>
            )}
          </motion.aside>
