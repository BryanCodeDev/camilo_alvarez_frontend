  ...
  if (variant === 'list') {
    return (
      <article className="card flex gap-4 p-4" role="listitem" aria-busy="true">
        <div className="skeleton w-24 h-24 rounded-lg flex-shrink-0" aria-hidden="true" />
        <div className="flex-1 space-y-3 min-w-0">
          ...
          <div className="skeleton h-6 w-1/3 rounded" aria-hidden="true" />
          <div className="skeleton h-5 w-1/4 rounded" aria-hidden="true" />
          <div className="flex gap-2">
            <div className="skeleton h-10 w-24 rounded-lg" aria-hidden="true" />
            <div className="skeleton h-10 w-24 rounded-lg" aria-hidden="true" />
    ...
    <article className="card" role="listitem" aria-busy="true">
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-baseline gap-3">
          ...
          <div className="skeleton h-4 w-1/5 rounded" aria-hidden="true" />
        </div>
