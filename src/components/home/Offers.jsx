...
const demoOffers = [
  {
    ...
    sku: 'AUD-APP-010',
    brand: 'Apple',
    images: ['/images/products/airpods-4-anc-1.jpg', '/images/products/airpods-4-anc-2.jpg'],
    featured: false,
    onSale: true,
    isNew: true,
    rating: 4.7,
  ...
  },
  {
    ...
    sku: 'CMP-APP-011',
    brand: 'Apple',
    images: ['/images/products/ipad-air-m2-1.jpg', '/images/products/ipad-air-m2-2.jpg'],
    featured: false,
    onSale: true,
    isNew: false,
    rating: 4.8,
  ...
  },
  {
    ...
    sku: 'AUD-SAM-012',
    brand: 'Samsung',
    images: ['/images/products/samsung-buds2-pro-1.jpg', '/images/products/samsung-buds2-pro-2.jpg'],
    featured: false,
    onSale: true,
    isNew: false,
    rating: 4.6,
  ...
  },
  {
    ...
    sku: 'PER-LOG-013',
    brand: 'Logitech',
    images: ['/images/products/logitech-mxmaster3s-1.jpg', '/images/products/logitech-mxmaster3s-2.jpg'],
    featured: false,
    onSale: true,
    isNew: false,
    rating: 4.9,
