      ...
      <div className="relative z-10 container-custom py-20 lg:py-32">
        ...
        >
          <motion.span
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-red-600/20 border border-red-600/30 text-red-400 text-sm font-medium mb-6"
          >
          ...
          >
            <MotionLink
              to="/tienda"
              className="group btn-primary px-8 py-4 text-lg gap-3"
          ...
          <motion.div
            ...
            className="mt-16 flex flex-wrap items-center justify-center gap-8 text-white text-sm"
          >
